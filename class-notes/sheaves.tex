...
\begin{proof}
  ...
  \item For \((\impliedby)\), \todo{Do this exercise}

    For \((\implies)\), we have by the first part that the
    ...
    \subset U\) such
    that \(\phi_{U_x}(s_{U_x}) = \phi_{U_x}(t)\). \todo{Finish this proof!}
  \end{enumerate}
\end{proof}
...
\begin{proof}
  ...
  \end{proof}
  \todo{Finish this proof and maybe try to understand the proof of the
  lemma better.}
\end{proof}
\begin{bibdiv}
  \begin{biblist}
