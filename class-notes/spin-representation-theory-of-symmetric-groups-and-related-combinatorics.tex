...
\end{defn}
\begin{prop}
  Let \(\lambda = (i^{m_i(\lambda)})_{i \geq 1}\) \todo{How does htis
    make sense. \(\lambda\) depends on itself...}. Then, the top
...
\begin{example}
  ...
  (3)\). This is in line with \todo{What is even going on in this
    example?}
\end{example}
\begin{bibdiv}
  \begin{biblist}
