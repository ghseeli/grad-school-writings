...
\end{defn}
\begin{example}
  In \ref{fig:weyl-chamber-a2}, the root system \(A_2\) is drawn with
  associated hyperplanes given by the dashed lines. Thus, there are
  \(6\) Weyl chambers with the shaded chamber corresponding to the
  chamber corresponding to the choice of simple system
  \(\{\alpha_1,\alpha_2\}\) chosen in the figure.
  \begin{figure}
