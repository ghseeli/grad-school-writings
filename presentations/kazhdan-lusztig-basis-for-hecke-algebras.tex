...
The Kazhdan-Lusztig basis was introduced in~\cite{kl} in order to
construct some representations of the Hecke algebra. While we will not
get into these representations here, we will define the basis and give
