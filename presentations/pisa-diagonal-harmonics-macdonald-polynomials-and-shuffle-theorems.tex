...
\title[Macdonald Catalanimals]{A Raising Operator Formula for
  Macdonald Polynomials (and The Journey There)} % The short title appears at the bottom of every slide, the full title is only on the title page
...
\medskip
Universit\'{a} di Pisa Seminar on Combinatorics, Lie Theory, and Topology\\ % Your institution for the title page
\medskip
%Based on arXiv:2112.07063 and arXiv:2307.06517
}
\date{12 October 2023} % Date, can be changed to a custom date
