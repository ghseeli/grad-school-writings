...
\medskip
University of Illinois Algebra-Geometry-Combinatorics Seminar\\ % Your institution for the title page
\medskip
%Based on arXiv:2112.07063 and arXiv:2307.06517
}
\date{20 February 2025} % Date, can be changed to a custom date
 ...
 a proof of the Rational Shuffle Theorem + a generalization. 
  ...
  \begin{columns}
    \begin{column}{0.3\textwidth}
      ...
      \draw[fill = black] (0,5.45) circle (0.15);
      \draw[fill = black] (11.4,0) circle (0.15);
      \draw[thick]
